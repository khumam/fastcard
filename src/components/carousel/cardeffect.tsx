  ...
  return (
    <Swiper
      ...
      modules={[EffectFlip]}>
        ...
        <div className="bg-white p-10 rounded border border-slate-200 flex flex-col justify-between gap-5 min-h-[390px] overflow-auto">
          <div>
          ...
          <div className="w-full flex items-end gap-1 justify-end pt-8">
            <button onClick={handleNext} className="text-slate-500 flex gap-1 text-lg">
        ...
        <SwiperSlide className="">
          <div className="bg-white p-10 rounded border border-slate-200 flex flex-col justify-between gap-5" onClick={handlePrev}>
            <div>
            ...
            <div className="w-full flex items-end gap-1 justify-end pt-8">
              <button onClick={handlePrev} className="text-slate-500 flex gap-1 text-lg">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" className="w-6 h-6">
